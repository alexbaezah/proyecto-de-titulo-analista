...
/* JAVASCRIPT: FORMULARIO DE REGISTRO DE USUARIO - JS*/
...
const validarFormulario = (e) => {
	switch (e.target.name) {
		...
		break;
		case 'tipo-usuario':
      		validarCampo(expresiones['tipo-usuario'], e.target, 'tipo-usuario');
      	break;				
	}
...
formulario.addEventListener('submit', (e) => {
	...
	validarCampo(expresiones.tipoUsuario, selectTipoUsuario, 'tipo-usuario');
});